...
-- Clinique de démo
INSERT INTO hopitaux (id, nom, code, ville, telephone)
VALUES ('a0000000-0000-0000-0000-000000000001',
        'Clinique Démo Douala', 'demo', 'Douala', '+237690000000')
ON CONFLICT (code) DO NOTHING;

-- Un service
INSERT INTO services (id, hopital_id, libelle)
VALUES ('c0000000-0000-0000-0000-000000000001',
        'a0000000-0000-0000-0000-000000000001', 'Médecine générale')
ON CONFLICT (id) DO NOTHING;

-- Un praticien
INSERT INTO praticiens (id, hopital_id, service_id, nom, prenom, specialite)
VALUES ('d0000000-0000-0000-0000-000000000001',
        'a0000000-0000-0000-0000-000000000001',
        'c0000000-0000-0000-0000-000000000001',
        'Fotso', 'Jean', 'Médecine générale')
ON CONFLICT (id) DO NOTHING;

-- Trois patients
INSERT INTO patients (id, hopital_id, numero_dossier, nom, prenom, sexe, telephone)
VALUES
 ('b0000000-0000-0000-0000-000000000001','a0000000-0000-0000-0000-000000000001','P-0001','Ngono','Marie','F','+237690000001'),
 ('b0000000-0000-0000-0000-000000000002','a0000000-0000-0000-0000-000000000001','P-0002','Mballa','Paul','M','+237690000002'),
 ('b0000000-0000-0000-0000-000000000003','a0000000-0000-0000-0000-000000000001','P-0003','Tchoua','Aline','F','+237690000003')
